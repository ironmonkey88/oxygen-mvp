...
> Use environment variables for database connection configurations
...
For a complete working example, see [config-with-env-vars.yml](https://github.com/oxy-hq/oxygen/blob/main/examples/config-with-env-vars.yml) in the examples directory.
