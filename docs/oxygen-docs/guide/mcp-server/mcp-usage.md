...
> Learn how to use the Model Context Protocol (MCP) server in Oxy to expose your data agents, workflows, SQL files, and semantic topics to AI assistants like Claude.
