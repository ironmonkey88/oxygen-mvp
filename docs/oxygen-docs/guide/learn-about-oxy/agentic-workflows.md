...
transitions:
  ...
  - type: looker_query
    description: Execute Looker queries against a configured Looker explore
    integration: looker
    model: finance_reporting
    explore: sales_segment_mrr
...
```yaml my-analysis.aw.yml theme={null}
model: openai-4o-mini
...
```yaml advanced-workflow.aw.yml theme={null}
