...
| consistency\_prompt | Custom evaluation prompt for consistency checking. Overrides workflow-level prompt. Supports Jinja templating with variables: `submission_1`, `submission_2`, `task_description`. | optional                   |
...
```yaml workflows/monthly_report.yml theme={null}
tasks:
