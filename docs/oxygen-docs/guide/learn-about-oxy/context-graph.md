...
> Interactive graph visualization of your data project's semantic and operational assets

The **Context Graph** is an interactive graph-based visualization and navigation tool that maps all semantic and operational assets in your Oxy project and their relationships. It provides a complete, visual understanding of how data flows through your system by showing connections between data assets, automations, and AI agents.

# What is the Context Graph?

The Context Graph feature creates a visual knowledge graph of your entire Oxy project, displaying:
...
The Context Graph visualizes 9 different types of nodes:
...
The Context Graph builds upon Oxy's semantic layer concepts:
...
## Accessing the Context Graph View

Navigate to the Context Graph page in the Oxy IDE to see the interactive graph visualization of your project.
...
The Context Graph makes it easy to trace how data flows through your system:
...
Before making changes, use the Context Graph to:
...
The Context Graph helps with AI agent development:

* **Agent Understanding**: Agents use the context graph to understand available data
...
The Context Graph follows this structure:
...
The Context Graph visualization uses:
...
Imagine you have a customer analytics agent. Using the Context Graph, you can trace:
...
1. Click on the view node in the Context Graph
...
The Context Graph feature is implemented in:

* **Types**: `/web-app/src/types/contextGraph.ts`
* **API Service**: `/web-app/src/services/api/contextGraph.ts`
* **UI Components**: `/web-app/src/pages/context-graph/`
* **React Hook**: `/web-app/src/hooks/api/contextGraph/useContextGraph.ts`
* **Semantic Specs**: `/crates/semantic/specs/` (view\.md, topic.md, entity.md)

# Best Practices

1. **Regular Review**: Periodically review the Context Graph to understand your project's evolution
2. **Before Major Changes**: Always check the Context Graph before refactoring or renaming assets
3. **Onboarding**: Use the Context Graph to help new team members understand the project structure
4. **Documentation**: Reference Context Graph screenshots in project documentation
5. **Cleanup**: Use the Context Graph to identify and remove unused assets

The Context Graph is your visual map to understanding, navigating, and maintaining your Oxy data project. It transforms abstract configurations into a concrete, explorable graph that makes complex relationships immediately clear.
