...
> How to write tests and use the oxy test CLI
...
<Info>
  **Default Prompt Reference:** The built-in `CONSISTENCY_PROMPT` provides
  detailed evaluation guidelines optimized for data analysis. View the [full
  default prompt in the source
  code](https://github.com/oxy-hq/oxygen-internal/blob/main/crates/core/src/config/constants.rs#L52-L159)
  to understand its logic or use it as a starting point for custom prompts.
</Info>
...
You can view the [default CONSISTENCY\_PROMPT source](https://github.com/oxy-hq/oxygen-internal/blob/main/crates/core/src/config/constants.rs#L52-L199), copy it, and modify the specific rules you need:
