...
The best way to set up an Oxy project is to use our [Claude Code skills repo](https://github.com/oxy-hq/skills), which can scaffold and configure everything for you interactively.

Below is a careful walkthrough of how our general principles work, so you can understand what's happening under the hood.
