...
<img height="300" class="rounded-md" src="https://mintcdn.com/oxy-internal/-wVM2K90JPw7QvxR/images/test-run.png?fit=max&auto=format&n=-wVM2K90JPw7QvxR&q=85&s=95a28e0c203d1b081a26c819645dbbc6" data-path="images/test-run.png" />
...
<Info>
  **See the default logic:** The built-in consistency evaluator uses a detailed
  ...
  prompt](https://github.com/oxy-hq/oxygen-internal/blob/main/crates/core/src/config/constants.rs#L52-L159)
...
* **Modified default**: Start with the [default prompt source](https://github.com/oxy-hq/oxygen-internal/blob/main/crates/core/src/config/constants.rs#L52-L199) and adapt it for your domain

**Example: Adapting the default prompt**

You can copy the default CONSISTENCY\_PROMPT and modify specific rules:
