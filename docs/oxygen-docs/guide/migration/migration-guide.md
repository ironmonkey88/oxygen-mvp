...
> Migrate your Oxy installation from SQLite to PostgreSQL using simple CLI commands
...
4. **Report issues** - [github.com/oxy-hq/oxygen/issues](https://github.com/oxy-hq/oxygen/issues)
