...
| `/erd` | Mermaid warehouse ERD + semantic-layer diagram | `portal/erd.html` → `/var/www/somerville/erd.html` (regenerated by `run.sh` step 9e via `scripts/generate_warehouse_erd.py` + `scripts/generate_semantic_layer_diagram.py` + `scripts/generate_erd_page.py`; shipped Plan 1b Session 30) |
| `/profile` | Per-column shape data | `portal/profile.html` → `/var/www/somerville/profile.html` (regenerated by `run.sh` step 9d via `scripts/generate_profile_page.py`; shipped Plan 1b Session 30) |
| `/dashboards` | Auto-generated Data Apps listing | `portal/dashboards.html` → `/var/www/somerville/dashboards.html` (regenerated by `run.sh` step 8c via `scripts/generate_dashboards_listing.py`; shipped Plan 17 Session 45) |
